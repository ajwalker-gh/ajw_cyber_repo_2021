...
Request Line, Headers, Body, Whitespace
...
10. What are the advantages of using `curl` over the browser? <br> Allows user to send and receive HTTP requests in a system that may not have a user interface such as a container.
...
Yes, this is indicated by Set-Cookie: SessionID=5
...
Strict-Transport-Security, X-Content-Type, X-Frame-Options, X-XSS-Protection
...
Container technology such as Ansible and Docker.
...
References
<br>
https://www.tutorialspoint.com/http/http_overview.htm <br>

https://everything.curl.dev/http/requests <br>
