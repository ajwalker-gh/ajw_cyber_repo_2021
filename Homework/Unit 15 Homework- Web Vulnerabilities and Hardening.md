...
Answer: Path - Path or Directory Traversal
   
3. Name three threat agents that can pose a risk to your organization.

Answer: Nation-States, Cybercriminals, Hacktivists 

4. What kinds of sources can act as an attack vector for injection attacks?

Answer: Poor configuration and lack of input validation allowing code to be injected into a web application forms triggering an unauthorized response from the database. 
...
Answer: Input validation/sanitation
____
...
Answer: Budget limitations, deadlines, poor planning/management. 

4. How might an attacker exploit the `robots.txt` file on a web server?

Answer: The `robots.txt` file can be harvested by an attacker and data such as the web-stack configuration, paths and sesnsitive info can be found. 

5. What steps can an organization take to obscure or obfuscate their contact information on domain registry web sites?

Answer: Implement WAF (Wab-Application Firewall) rules that prohibit scans for contact information. Using private domains containing contact info. 
   
6. True or False: As a network defender, `Client-Side` validation is preferred over `Server-Side` validation because it's easier to defend against attacks.

   - Explain why you chose the answer that you did.

Answer: False as the possibility of exploitation is higher if validation is undertaken on the Client-Side. 
...
Answer: Traffic passing through the web-application. 
...
1. Define all four factors of multifactor authentication and give examples of each:
   ...
   - Factor 1: Standard Login Inputs - eg. password, PIN, security questions.

   
   - Factor 2: Physical Keys - eg. smartcards, tokens, keys. 
   
   
   - Factor 3: Biometrics - eg. Iris/retina scanners, hand geometry. 

   
   - Factor 4: Location - eg. GPS detection, home number callback. 
...
Answer: Determines and restricts what a user can see and do based on their privileges eg. editing or only viewing a document. 
...
![Hidden Javascript](./Images/hiddenjava.png) 
...
![CreditCardNumbers](./Images/creditcards.png)
